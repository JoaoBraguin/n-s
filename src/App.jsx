...
function App() {
  ...
  const series = [
    { src: foto1.src , title: "", description: "" },
    { src: foto2.src , title: "", description: "" },
    ...
    { src: foto9.src , title: "", description: "" },
    { src: foto10.src , title: "", description: "" },
    { src: foto11.src , title: "", description: "" },
    { src: foto12.src , title: "", description: "" },
    { src: foto13.src , title: "", description: "" },
    { src: foto14.src , title: "", description: "" },
    { src: foto15.src , title: "", description: "" },
    { src: foto16.src , title: "", description: "" },
    { src: foto17.src , title: "", description: "" },
    { src: foto18.src , title: "", description: "" },
    { src: foto19.src , title: "", description: "" },
    { src: foto20.src , title: "", description: "" },
    { src: foto21.src , title: "", description: "" },
    { src: foto22.src , title: "", description: "" },
    { src: foto23.src , title: "", description: "" },
    { src: foto24.src , title: "", description: "" },
  ];

  const momentos = [
    { data: "27 de março de 2026", title: "Estávamos juntos na minha primeira prova de calculo🤍", description: "", src: foto1.src  },
    { data: "26 de abril de 2026", title: "Primeiro trabalho que fizemos juntos🤍", description: "", src: foto2.src  },
    { data: "7 de junho de 2026", title: "Primeira janta juntos🤍", description: "Primeira vez que fui na sua casa", src: foto14.src },
    { data: "13 de junho de 2026", title: "Nosso primeiro jogo de Copa juntos🤍", description: "Brasil x Marrocos", src: foto13.src  },
    { data: "19 de junho de 2026", title: "Primeira missa juntos🤍", description: "Primeira Benção juntos também ", src: foto12.src  },
    { data: "24 de de junho de 2026", title: "Nosso segundo jogo De Copa juntos🤍", description: "Brasil x Escócia", src: foto11.src  },
    { data: "27 de junho de 2026", title: "Primeira festa junina juntos🤍", description: "Dia que conheceu minha família", src: foto10.src  },
    { data: "29 de junho de 2026", title: "Nosso terceiro jogo De Copa juntos🤍", description: "Brasil x Japão", src: foto9.src  },
    { data: "3 de julho de 2026", title: "Nosso primeiro Cinema juntos🤍", description: "Toy Story", src: foto20.src  },
    { data: "16 de julho de 2026", title: "Dia de Nossa Senhora do Carmo🤍", description: "", src: foto17.src  },
    { data: "17 de julho de 2026", title: "Nosso primeiro quitute juntos🤍", description: "Foto junto com o Chavinho | Dia 1", src: foto15.src  },
    { data: "17 de julho de 2026", title: "Nosso primeiro quitute juntos🤍", description: "Dia 1", src: foto16.src  },
    { data: "18 de julho de 2026", title: "Nosso primeiro quitute juntos🤍", description: "Dia 2", src: foto18.src },
    { data: "26 de julho de 2026", title: "Pedido na Roda Gigante 🤍", description: "Oficialmente namorados 🤍", src: foto21.src },
    { data: "26 de julho de 2026", title: "Dia Dos Brinquedos 🤍", description: "Dia 3", src: foto22.src },
    { data: "26 de julho de 2026", title: " Montanha Russa 🤍", description: "Dia 3 ", src: foto23.src },
    { data: "26 de julho de 2026", title: "Nosso pedido de namoro 🤍", description: "Nossas Alianças 🤍", src: foto24.src },
